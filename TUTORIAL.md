...
> <walkthrough-pin-section-icon></walkthrough-pin-section-icon> In case you want to set your own VPC, SUBNET or DRZ configurations, <walkthrough-editor-open-file filePath="./.env">edit</walkthrough-editor-open-file> the **.env** file manually and set the **Optional Variables** accordingly, and then run `source .env` to reload.
